...
const PROJECTS = [
  ...
  },
  {
    ...
    tag: 'social tools',
    accent: '#60a5fa',
    desc: 'One reference address and a unified inbox for WhatsApp, Telegram, Instagram, LinkedIn, Facebook, X, email and more.',
    chips: ['JavaScript', 'WebExtension'],
    honest: 'Prototype; extension wraps the standalone web app.',
    href: 'https://github.com/dkcb/multi-social',
  },
  {
    name: 'multi-tab-addon',
    tag: 'tab management',
    accent: '#34d399',
    desc: 'Firefox WebExtension that organizes tabs into nested, recursive groups and switches whole workspaces.',
    chips: ['JavaScript', 'WebExtension'],
    honest: 'Prototype; Firefox 139+ tabGroups API.',
    href: 'https://github.com/dkcb/multi-tab-addon',
  },
  {
    name: 'solar_overkill',
    tag: 'battery / solar',
    accent: '#fbbf24',
    desc: 'BMS app fork for monitoring and managing battery systems with Python.',
    chips: ['Python'],
    honest: 'Fork; focused on BMS integration.',
    href: 'https://github.com/dkcb/solar_overkill',
  },
  {
    name: 'n8n-mcp',
    tag: 'automation',
    accent: '#a78bfa',
    desc: 'MCP server for Claude Desktop / Code / Windsurf / Cursor to build n8n workflows.',
    chips: ['TypeScript', 'n8n'],
    honest: 'Forked from czlonkowski/n8n-mcp.',
    href: 'https://github.com/dkcb/n8n-mcp',
  },
  {
    name: 'multilayer_preception',
    tag: 'ML placeholder',
    accent: '#f0abfc',
    desc: 'Placeholder for multi-layer perceptron experiments.',
    chips: ['Python'],
    honest: 'Empty repo; name is a typo and may be renamed.',
    href: 'https://github.com/dkcb/multilayer_preception',
  },
  {
    name: 'get_next_line',
    tag: 'systems / C',
    accent: '#60a5fa',
    desc: 'Read a file descriptor line by line in C with a configurable buffer size.',
    chips: ['C'],
    honest: '42 solo project.',
    href: 'https://github.com/dkcb/get_next_line',
  },
  {
    name: 'get_next_line_unconventional',
    tag: 'systems / C',
    accent: '#60a5fa',
    desc: 'An unconventional experimental take on get_next_line in C.',
    chips: ['C'],
    honest: '42 experiment; includes a test main.',
    href: 'https://github.com/dkcb/get_next_line_unconventional',
  },
  {
    name: 'philosophers',
    tag: 'concurrency / C',
    accent: '#fbbf24',
    desc: 'Dining philosophers problem: threads, mutexes, and starvation/deadlock avoidance.',
    chips: ['C', 'pthreads'],
    honest: '42 project; GPL v3.',
    href: 'https://github.com/dkcb/philosophers',
  },
  {
    name: 'pipex',
    tag: 'systems / C',
    accent: '#60a5fa',
    desc: 'Reproduce shell pipe behavior in C: cmd1 < infile | cmd2 > outfile.',
    chips: ['C', 'Unix'],
    honest: '42 project.',
    href: 'https://github.com/dkcb/pipex',
  },
  {
    name: 'push_swap',
    tag: 'algorithms / C',
    accent: '#f0abfc',
    desc: 'Sort a stack of integers with a limited instruction set.',
    chips: ['C'],
    honest: '42 project.',
    href: 'https://github.com/dkcb/push_swap',
  },
  {
    name: 'fdf',
    tag: 'graphics / C',
    accent: '#34d399',
    desc: '3D wireframe representation of a height map using MiniLibX.',
    chips: ['C', 'MiniLibX'],
    honest: '42 project; macOS MiniLibX.',
    href: 'https://github.com/dkcb/fdf',
  },
  {
    name: 'ft_printf',
    tag: 'systems / C',
    accent: '#60a5fa',
    desc: 'Re-implementation of printf in C.',
    chips: ['C'],
    honest: '42 project.',
    href: 'https://github.com/dkcb/ft_printf',
  },
  {
    name: 'cube3d',
    tag: 'graphics / C',
    accent: '#34d399',
    desc: 'Wolfenstein 3D-style raycasting engine in C.',
    chips: ['C', 'MiniLibX'],
    honest: '42 project.',
    href: 'https://github.com/dkcb/cube3d',
  },
  {
    name: 'libft',
    tag: 'systems / C',
    accent: '#6ee7b7',
    desc: 'First C library from scratch: libc re-implementations and string utilities used by later curriculum.',
    chips: ['C'],
    honest: '42 project; used by pipex, minishell, fdf, and others.',
    href: 'https://github.com/dkcb/libft',
  },
];

const STACK = [
  ["Languages", "C · C++ · TypeScript · JavaScript · Python"],
  ["Web", "React · Vite · TypeScript · WebExtensions · Node/NestJS via team projects"],
  ["Data / ML", "Python · matplotlib · gradient descent from scratch"],
  ["Tooling", "Git · Linux · Jest · Docker"],
];

const TYPE_LINES = [
  "front-ends for AI-agent platforms.",
  "browser extensions and social tools.",
  "shells, in C.",
